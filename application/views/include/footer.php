...
<div class="footer py-5">
    ...
    <span class="badge badge-light">  <img src="<?php echo $res->item->thumb;?>" width="15px;"/> <?php echo $res->item->name;?> <span class="badge badge-warning"><?php echo $res->item->symbol;?></span></span>
</a>
	<?php
		}
				?>
            ...
            <?php
             setlocale(LC_MONETARY,"en_US");
             foreach ($globalData->data->market_cap_percentage as $key => $value)
				{
					?>
            <span class="badge badge-light"> <?php echo strtoupper($key). ' '. number_format( $value, 1); ?>%</span>
			<?php
		        }
				    ?>
			    </div></div>
                        ...
                        <div class="col-md-12">
                            <div class="d-flex">
                                <div class="f-nav mr-auto">
                                 ...
                                 <p><?php echo $settingData[0]['copyright'] ?><br><small>Data provided by <a href="https://www.coingecko.com/" rel="nofollow" target="_blank"> CoinGecko</a></small></p>
                            </div>
                        </div>
                    </div>
                </div>
